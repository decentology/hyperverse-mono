			...
			<div className="modal-content">
				<div className="card">
					<header className="card-header">
						<p className="card-header-title">Transaction Signature</p>
					</header>
					<div className="card-content">
						<div className="content">
							<p>
								Your signature is required to submit this transaction to the
								blockchain.
							</p>
							{device.isMobile && (
								<p>
									Please tap <em>sign</em> to be taken to the{' '}
									<strong>Algorand Wallet</strong>.
								</p>
							)}
							{device.isDesktop && (
								<p>
									Please open up your <strong>Algorand Wallet</strong> on your
									mobile device.
								</p>
							)}
						</div>
