    ...
    IHyperverseModule
{
    ...
    modifier checkMint() {
        if (isPublicSaleActive == false && msg.sender != _tenantOwner) {
            revert Unauthorized();
        }
        _;
    }
    ...
    function mint() external payable nonReentrant checkMint {
    ...
    function withdrawTokens(IERC20 token) public isTenantOwner {
