...
<div className="body">
	...
	<b>useERC721.ts</b> to get a better idea of what we'll need. We can see that this function needs
	an <b>account</b> in order to return a number for the balance.
</div>
...
<div className="body">
	...
	<b>Demo</b>. We provide an initial address of <b>0x70997970c51812dc3a010c7d01b50e0d17dc79c8</b>{' '}
	that we will pass through as the account that <b>getBalanceOf</b> requires.
</div>
