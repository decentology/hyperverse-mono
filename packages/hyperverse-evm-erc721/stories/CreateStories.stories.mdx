...
<div className="body">
	...
	<b>erc721Library.ts</b> to get a better idea of what we'll need. We can see that this function needs
...
<div className="body">
	...
	that we will pass through as the account that <b>getBalanceOf</b> requires. Feel free to replace this address
  with another.
</div>
