...
export function ERC721Library(...args: Parameters<typeof ERC721LibraryInternal>): CancellablePromise<ERC721LibraryType> {
	return new CancellablePromise(ERC721LibraryInternal(...args), () => { });
}
...
export async function ERC721LibraryInternal(
  ...
  const getBalanceOf = async (account: string) => {
		try {
      console.log('in the try', account)
