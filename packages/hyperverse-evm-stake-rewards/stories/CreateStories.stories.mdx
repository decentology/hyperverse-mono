...
<div className="smallerheading">useStakeRewards.ts</div>

Before we begin writing our story, we'll take a look at the `getBalanceOf` function from `useStakeRewards.ts` to
