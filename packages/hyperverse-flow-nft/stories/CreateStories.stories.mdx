...
<div className="smallerheading">getBalance.ts</div>

Before we begin writing our story, we'll take a look at the `getAllTribes` function from `getAllTribes.ts` to
