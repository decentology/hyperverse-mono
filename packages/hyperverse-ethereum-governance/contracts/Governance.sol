 ...
 */
abstract contract Governor is Context, ERC165, EIP712, IGovernor, IHyperverseModule {
	...
	function init(string memory _nameInit, address _tenant) external {
		_name = _nameInit;
		tenantOwner = _tenant;

		EIP712(_nameInit, version());
	}
