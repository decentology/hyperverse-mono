...
Let's walkthrough how we set up **Get All Tribes** for an example.

<div className="smallerheading">getAllTribes.ts</div>
...
<div className="smallerheading">getAllTribes.stories.tsx</div>
...
will call the **GetAllTribes** component. It is binded with our first story we have titled **Demo**.
We provide an initial tenant Id of `0x62a7aa79a52591Ccc62B71729329A80a666fA50f` that we will pass
through as the account that `getAllTribes` requires.
