...
export const ArrowRight = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0.125 0.125 13.75 13.75" height="27" width="27" strokeWidth="0.75">
    <g>
      <line
        x1="0.5"
        y1="7"
...
export const Info = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" height="16" width="16">
    ...
    ></path>
    <path stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" d="M5.5 10H8.5"></path>
    <path
      stroke="#ffffff"
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7 4.5C7.27614 4.5 7.5 4.27614 7.5 4C7.5 3.72386 7.27614 3.5 7 3.5C6.72386 3.5 6.5 3.72386 6.5 4C6.5 4.27614 6.72386 4.5 7 4.5Z"
    ></path>
    <path stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" d="M7 10V6.5H6"></path>
  </svg>
)
