	...
	return (
		<MoudlesContainer>
			...
			<ModuleGrid>
				...
				<InfoBox {...ModulesInfo[Modules.erc20]} />
				<InfoBox {...ModulesInfo[Modules.erc777]} />
				{/* <InfoBox {...ModulesInfo[Modules.randomPick]} />
				<InfoBox {...ModulesInfo[Modules.stakeRewards]} />
				<InfoBox {...ModulesInfo[Modules.tribes]} />
				<InfoBox {...ModulesInfo[Modules.whitelist]} /> */}
			</ModuleGrid>
			<ModulesHeader>
