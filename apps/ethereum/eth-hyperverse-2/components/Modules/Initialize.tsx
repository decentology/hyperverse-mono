		...
		<InitizalizeContainer>
			<InfoContainer>
				<InfoBox
					...
					description="Smart Modules separate smart contract logic from their associated data allowing each module to clone many different instances (known as tenants) from the main contract."
